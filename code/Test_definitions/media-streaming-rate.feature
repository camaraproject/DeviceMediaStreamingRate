Feature: CAMARA Media Streaming Rate API, vwip - Operation retrieveMaximumDownstreamMediaRate
  ...
  #
  # References to OAS spec schemas refer to schemas specified in media-streaming-rate.yaml
  # or, for referenced common schemas, in CAMARA_common.yaml

  Background: Common Media Streaming Rate setup
    Given an environment at "apiRoot"
    And the resource "/media-streaming-rate/vwip/retrieve-maximum-downstream-media-rate"
    And the header "Content-Type" is set to "application/json"
    And the header "Authorization" is set to a valid access token
    And the header "x-correlator" complies with the schema at "#/components/schemas/XCorrelator"
    And the request body is set by default to a request body compliant with the schema at "#/components/schemas/MediaStreamingRateRequest"

  ##########################
  # Happy path scenarios
  ##########################

  @media_streaming_rate_01_two_legged_device_in_body
  Scenario: Retrieve the maximum downstream media streaming rate with a two-legged access token
    ...
    And the response body complies with the OAS schema at "#/components/schemas/MediaStreamingRateResponse"
  ...
  @media_streaming_rate_02_three_legged_device_from_token
  ...
  @media_streaming_rate_03_multiple_device_identifiers
  ...
  @media_streaming_rate_400.1_no_request_body
  ...
  @media_streaming_rate_400.2_empty_request_body
  ...
  @media_streaming_rate_400.3_unknown_property
  ...
  @media_streaming_rate_C01.01_device_empty
  ...
  @media_streaming_rate_C01.02_device_identifiers_not_schema_compliant
  ...
  @media_streaming_rate_C01.03_device_not_found
  ...
  @media_streaming_rate_C01.04_unnecessary_device
  ...
  @media_streaming_rate_C01.05_missing_device
  ...
  @media_streaming_rate_C01.06_unsupported_device
  ...
  @media_streaming_rate_C01.07_device_not_supported
  ...
  @media_streaming_rate_401.1_no_authorization_header
  ...
  @media_streaming_rate_401.2_expired_access_token
  ...
  @media_streaming_rate_401.3_invalid_access_token
  ...
  @media_streaming_rate_403.1_missing_access_token_scope
  Scenario: Access token does not include the required scope
    Given the header "Authorization" is set to a valid access token which does not include the scope "media-streaming-rate:retrieve-maximum-downstream-media-rate"
    And the request body property "$.device" is set to a valid device supported by the implementation
    When the request "retrieveMaximumDownstreamMediaRate" is sent
